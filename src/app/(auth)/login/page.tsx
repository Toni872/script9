                ...
                >
                    ...
                    <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-sm">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 text-[#86868b] hover:text-[#1d1d1f] p-1"
                        ...
                        <div className="flex items-center gap-4 my-6 sm:my-8">
                            ...
                            <span className="text-[13px] text-[#86868b]">O continúa con</span>
                            <div className="flex-1 h-px bg-gray-200"></div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4">
                            <button
                                ...
                                disabled={loading}
                                className="flex items-center justify-center gap-2 px-4 py-3.5 sm:py-3 border border-gray-300 rounded-xl hover:bg-gray-50 active:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
                            >
                            ...
                            <button
                                type="button"
                                disabled
                                className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl opacity-50 cursor-not-allowed"
                            >
