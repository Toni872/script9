    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center gap-3 p-4 border-b border-gray-200 bg-white">
                ...
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#8B5CF6] to-purple-400 flex items-center justify-center text-white font-semibold">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-40 text-center">
                        ...
                        <button
                            ...
                            className="mt-2 px-4 py-2 bg-[#8B5CF6] text-white rounded-lg hover:bg-[#7c3aed] transition-colors"
                        >
                            Reintentar
                        </button>
                    </div>
            ...
            <div className="p-4 border-t border-gray-200 bg-white">
                <div className="flex gap-2">
                    <textarea
                        ...
                        className="flex-1 resize-none border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#8B5CF6] focus:border-transparent"
                        rows={1}
                        disabled={sending}
                    />
                    <button
